      ...
      {loading ? (
        ...
        <ul className="m-0 flex list-none flex-col gap-1.5 p-0">
          {pageItems.map((record) => (
            <li
              key={record.id}
              className="relative flex flex-wrap items-center gap-x-4 gap-y-1.5 rounded-ctl border border-line bg-white/[0.02] py-2.5 pl-5 pr-3 transition-all duration-150 ease-hud hover:border-line-bright hover:bg-white/[0.05]"
            >
              <span
